this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
  ...
  var La = ["cpowf", "modff", "execl", "cxref", "fdimf", "fopen", "fmodf", "strip", "mblen", "fread", "floor", "rintf", "colon", "fseek", "mknod", "fgetc", "atanl", "logbf", "ccosl", "rintl", "fgets", "pause", "fminl", "hypot", "write", "clogf", "fcntl", "cpowl", "fputs", "cksum", "cabsl", "fabsf", "dirfd", "lockf", "acosl", "tanhf", "srand", "twalk", "shmdt", "csinf", "stdin", "lstat", "mailx", "nohup", "crypt", "errno", "cproj", "ctags", "readv", "paste", "lseek", "ntohs", "batch", "fmaxf", "ccosh", "shmat", "ioctl", "asinh", "creat", "erfcf", "isinf", "btowc", "ceill", "qsort", "llabs", "fstat", "sleep", "erfcl", "switch", "fwide", "raise", "cargf", "semop", "atanh", "cexpf", "tsort", "fmodl", "conjl", "execv", "iconv", "scanf", "fputc", "unset", "logbl", "error", "htons", "utime", "alarm", "cflow", "ceilf", "coshl", "shift", "coshf", "getwc", "asinl", "sqrtl", "chgrp", "fabsl", "cacos", "ctanf", "qhold", "fuser", "split", "fsync", "cabsf", "tanhl", "ctime", "msync", "mlock", "while", "fminf", "times", "clogl", "csinl", "lldiv", "lrint", "alias", "conjf", "umask", "trunc", "abort", "lfind", "delta", "ilogb", "chown", "atanf", "patch", "fmaxl", "rmdir", "sinhl", "cimag", "ipcrm", "union", "ifdef", "ctanl", "chdir", "casin", "round", "acosf", "admin", "mkdir", "ntohl", "sqrtf", "frexp", "cargl", "sinhf", "creal", "wctob", "chmod", "cexpl", "short", "csinh", "unget", "tfind", "const", "cbrtf", "popen", "touch", "close", "acosh", "endif", "fdiml", "dlsym", "ctanh", "qstat", "qmove", "ldexp", "putwc", "break", "undef", "rmdel", "isnan", "ccosf", "xargs", "catan", "false", "atoll", "cbrtl", "htonl", "modfl", "csqrt", "pread", "tzset", "uname", "ftell", "clock", "float", "asinf"],
      Ta = [],
  ...
  var Ya = "pwdle_statistics", Ja = "fail", Ua = {
    currentStreak: 0,
    maxStreak: 0,
  ...
  ***************************************************************************** */
          ...
          p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function (a) {
            ...
            As(function (e) {
              var a = e.evaluations, s = e.dayOffset, t = e.rowIndex, o = e.isHardMode, n = e.isWin,
                  ...
                  i = JSON.parse(window.localStorage.getItem(S)), l = "pwdle ".concat(s);
  ...
  $s.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong><code>pwdle</code></strong> in 6 tries.</p>\n      <p>Each guess must be a valid 5 letter C keyword, POSIX C identifier or POSIX command. Hit the enter button to submit.</p>\n      <p>After each guess, the color of the tiles will change to show how close your guess was to the word.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="w" evaluation="correct" reveal></game-tile>\n            <game-tile letter="h"></game-tile>\n            <game-tile letter="i"></game-tile>\n            <game-tile letter="l"></game-tile>\n            <game-tile letter="e"></game-tile>\n          </div>\n          <p>The letter <strong><code></code>w</strong> is in the word and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="r" evaluation="present" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="t"></game-tile>\n          </div>\n          <p>The letter <strong>r</strong> is in the word but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="x"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="r"></game-tile>\n            <game-tile letter="g" evaluation="absent" reveal></game-tile>\n            <game-tile letter="s"></game-tile>\n          </div>\n          <p>The letter <strong>g</strong> is not in the word in any spot.</p>\n        </div>\n      </div>\n      <p><strong>A new <code>pwdle</code> will be available each day!<strong></p>\n    </div>\n  </section>\n';
  var Hs = function (e) {
    r(t, e);
    var a = h(t);
