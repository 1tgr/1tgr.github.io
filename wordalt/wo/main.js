this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
  ...
  var La = ["aa", "ab", "ad", "ae", "ah", "ai", "ak", "al", "am", "an", "ao", "ar", "as", "at", "aw", "ax", "ay", "ba", "be", "bo", "bu", "by", "ca", "ce", "da", "de", "di", "do", "ea", "ed", "eh", "el", "em", "en", "er", "es", "eu", "ex", "ey", "fa", "fe", "fi", "fo", "fu", "ga", "ge", "gi", "go", "ha", "he", "hi", "ho", "hu", "hy", "id", "ie", "if", "in", "io", "is", "it", "ji", "jo", "ju", "ka", "ko", "la", "li", "lo", "lu", "ly", "ma", "me", "mi", "mo", "mr", "mu", "my", "na", "ne", "ni", "no", "nu", "od", "oe", "of", "og", "oh", "ok", "om", "on", "or", "os", "ow", "ox", "pa", "pi", "po", "pu", "ra", "re", "ro", "sa", "se", "sh", "si", "so", "st", "ta", "td", "te", "th", "ti", "to", "tu", "ud", "ug", "um", "un", "up", "ur", "us", "ut", "vu", "wa", "we", "wi", "wo", "wu", "wy", "xi", "ya", "ye", "ym", "yn", "yo", "yr", "za", "zo"],
      Ta = [],
  ...
  var Za = "IN_PROGRESS", es = "WIN", as = "FAIL",
      ss = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Phew"], ts = function (e) {
        ...
        function t() {
          ...
          var o = za();
          return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(3).fill(""), e.evaluations = new Array(3).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja({
            rowIndex: e.rowIndex,
        ...
        return o(t, [{
          key: "evaluateRow", value: function () {
            if (2 === this.tileIndex && !(this.rowIndex >= 3)) {
              ...
              var i = this.rowIndex >= 3, l = r.every((function (e) {
                return "correct" === e
              }));
              if (i || l) Va({
                isWin: l,
          ...
          key: "addLetter", value: function (e) {
            this.gameStatus === Za && (this.canInput && (this.tileIndex >= 2 || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
          }
        }, {
          ...
          key: "submitGuess", value: function () {
            if (this.gameStatus === Za && this.canInput) {
              if (2 !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Not enough letters");
              this.evaluateRow()
            }
          }
        }, {
          ...
          key: "sizeBoard", value: function () {
            var e = this.shadowRoot.querySelector("#board-container"),
                a = Math.min(Math.floor(e.clientHeight * (2 / 3)), 350), s = 3 * Math.floor(a / 2);
          ...
          key: "showStatsModal", value: function () {
            ...
            this.gameStatus === es && this.rowIndex <= 3 && a.setAttribute("highlight-guess", this.rowIndex), a.gameApp = this, e.appendChild(a), e.setAttribute("open", "")
          }
        }, {
          ...
          key: "connectedCallback", value: function () {
            ...
            for (var a = 0; a < 3; a++) {
              ...
              s.setAttribute("letters", this.boardState[a]), s.setAttribute("length", 2), this.evaluations[a] && (s.evaluation = this.evaluations[a]), this.$board.appendChild(s)
            }
          ...
          p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function (a) {
            ...
            As(function (e) {
              var a = e.evaluations, s = e.dayOffset, t = e.rowIndex, o = e.isHardMode, n = e.isWin,
                  ...
                  i = JSON.parse(window.localStorage.getItem(S)), l = "Wo ".concat(s);
